    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-6 py-16 prose prose-slate dark:prose-invert">
        ...
        <p className="mt-6 text-lg text-muted">
          STEMVerse is a unified educational and professional engineering platform. Learners progress from visual programming to Blockly robotics, IoT, AI, and beyond — without migrating to another tool.
        </p>
