...
export const LCD1602_ASSET: ComponentAssetDefinition = {
  ...
  imageWidth: 420,
  imageHeight: 230,
  rotationCenter: { x: 210, y: 115 },
  selectionBounds: { x: 0, y: 0, width: 420, height: 230 },
  defaultScale: 1.0,
  metadata: {
    columns: 16,
    rows: 2,
  ...
  pinCoordinates: [
    { name: 'GND', number: 1, pixelX: 142, pixelY: 225, anchorX: 142, anchorY: 225, signalType: 'GND' },
    { name: 'VCC', number: 2, pixelX: 162, pixelY: 225, anchorX: 162, anchorY: 225, signalType: 'POWER' },
    { name: 'SDA', number: 3, pixelX: 180, pixelY: 225, anchorX: 180, anchorY: 225, signalType: 'I2C' },
    { name: 'SCL', number: 4, pixelX: 200, pixelY: 225, anchorX: 200, anchorY: 225, signalType: 'I2C' },
  ],
  wireAnchorPoints: [
    { anchorId: 'pin_GND', x: 142, y: 225 },
    { anchorId: 'pin_VCC', x: 162, y: 225 },
    { anchorId: 'pin_SDA', x: 180, y: 225 },
    { anchorId: 'pin_SCL', x: 200, y: 225 },
  ],
